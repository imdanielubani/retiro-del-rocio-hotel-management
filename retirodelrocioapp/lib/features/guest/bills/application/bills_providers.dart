...
final billsRepositoryProvider = Provider<BillsRepository>((ref) => BillsRepository());
...
final billProvider = FutureProvider.autoDispose
    .family<Bill, String>((ref, deviceToken) {
...
class BillActions {
  ...
  Future<BillPaymentConfirmation> confirmPaystack(String reference) =>
      _ref.read(billsRepositoryProvider).confirmPaystack(_deviceToken, reference);
}
