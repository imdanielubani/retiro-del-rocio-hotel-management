...
enum MaintenanceNotificationCategory {
  ...
  static MaintenanceNotificationCategory fromApi(String? value) => MaintenanceNotificationCategory.values.firstWhere(
...
class MaintenanceNotification {
  ...
  factory MaintenanceNotification.fromJson(Map<String, dynamic> json) => MaintenanceNotification(
    id: (json['id'] as num?)?.toInt() ?? 0,
    category: MaintenanceNotificationCategory.fromApi(json['category'] as String?),
