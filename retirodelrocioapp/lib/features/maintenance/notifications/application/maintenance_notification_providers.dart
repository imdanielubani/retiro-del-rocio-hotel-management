...
final maintenanceNotificationRepositoryProvider =
    Provider<MaintenanceNotificationRepository>(
...
/// actually lands.
final maintenanceNotificationsProvider =
    FutureProvider.family<List<MaintenanceNotification>, String>((
      ref,
      token,
    ) async {
...
final maintenanceUnreadNotificationsProvider = Provider.family<int, String>((
  ref,
  token,
) {
...
final maintenanceNotificationChimeProvider = Provider.family<void, String>((
  ref,
  token,
) {
...
class MaintenanceNotificationActions {
  ...
  Future<void> markRead(int id) async {
    await _ref
        .read(maintenanceNotificationRepositoryProvider)
        .markRead(_token, id);
...
final maintenanceNotificationActionsProvider =
    Provider.family<MaintenanceNotificationActions, String>(
