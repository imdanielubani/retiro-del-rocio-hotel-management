...
/// Void one line item — reached by tapping the void icon on that item's row
/// in the Order Detail screen. Resolves the reason string (possibly empty)
/// on confirm, or `null` if cancelled.
Future<String?> showVoidItemDialog(BuildContext context, BarOrderItem item) {
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'e.g. Wrong drink, guest changed mind',
