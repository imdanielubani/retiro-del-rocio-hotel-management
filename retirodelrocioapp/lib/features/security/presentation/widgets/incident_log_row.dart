  ...
  Widget _badge(IncidentStatusStyle style) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: style.color.withValues(alpha: active ? 0.3 : 0.1),
        ),
      ),
      child: Column(
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(10),
              border: Border.all(
                color: color.withValues(alpha: incident.isActive ? 0.35 : 0.3),
              ),
            ),
            child: busy
                ? SizedBox(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 4),
          Text(label, style: AppTypography.style(color: color, fontSize: 10)),
        ],
      ),
    );
  }
