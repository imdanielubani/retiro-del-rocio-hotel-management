  ...
  factory IncidentStatusStyle.of(SecurityIncident incident) {
    return switch (incident.status) {
      IncidentStatus.active =>
        const IncidentStatusStyle._(_red, 'Unacknowledged', 'assets/icons/sos red.png'),
      IncidentStatus.acknowledged =>
        const IncidentStatusStyle._(_amber, 'Acknowledged', 'assets/icons/sos yellow.png'),
      IncidentStatus.resolved =>
        const IncidentStatusStyle._(_green, 'Resolved', 'assets/icons/sos green.png'),
      IncidentStatus.cancelled =>
        const IncidentStatusStyle._(_grey, 'Cancelled', 'assets/icons/sos green.png'),
    };
  }
}
