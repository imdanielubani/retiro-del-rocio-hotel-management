{{-- Kitchen order detail drawer. $selected = ?DiningOrder. --}}
@if ($showDetail && $selected)
    @php [$sC,$sB]=$selected->statusColors(); $next = \App\Livewire\Admin\Kitchen\Orders::FLOW[$selected->status] ?? null; @endphp
