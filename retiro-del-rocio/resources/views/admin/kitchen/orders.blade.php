<div class="flex flex-col gap-4">
    ...
    <div class="overflow-hidden rounded-xl border border-[#e5e7eb] bg-white">
        @if ($orders->isEmpty())
            <div class="flex flex-col items-center justify-center gap-3 py-16 text-center">
                ...
                <p class="text-[13px] text-[#6b7280]">Food orders placed from the guest tablet will appear here.</p>
            </div>
        @else
                    ...
                    <tbody>
                        @foreach ($orders as $o)
                            ...
                            <tr wire:key="do-{{ $o->id }}" class="border-b border-[#e5e7eb] {{ $loop->even ? 'bg-[#f9fafb]' : 'bg-white' }}">
                                ...
                                <td class="px-4 py-3.5 text-right">@include('admin.kitchen.partials.order-menu', ['o' => $o])</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
            ...
            <div class="flex flex-col divide-y divide-[#e5e7eb] md:hidden">
                @foreach ($orders as $o)
                    ...
                    <div wire:key="do-m-{{ $o->id }}" class="flex flex-col gap-2 px-4 py-3.5">
                        ...
                        <div class="flex justify-end pt-1">@include('admin.kitchen.partials.order-menu', ['o' => $o])</div>
                    </div>
                @endforeach
            </div>
    ...
    @include('admin.kitchen.partials.order-detail')
</div>
