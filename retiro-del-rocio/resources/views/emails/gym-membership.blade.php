...
<head>
    ...
    <title>Gym Membership Active</title>
</head>
                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <div style="display:inline-block;background:#dcfce7;color:#16a34a;font-size:13px;font-weight:bold;padding:6px 14px;border-radius:999px;">Membership active</div>
                            <h2 style="margin:18px 0 6px;font-size:20px;">Dear {{ $membership->customer_name ?: 'Member' }},</h2>
                            <p style="margin:0 0 20px;font-size:15px;line-height:1.6;color:#374151;">
                                Welcome to the {{ config('app.name') }} gym. Your {{ $membership->typeLabel() }} payment has been received and your membership is now active.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-size:15px;line-height:1.6;border:1px solid #eef0ec;border-radius:10px;">
                                ...
                                <tr>
                                    <td style="padding:12px 16px;color:#6b7280;border-bottom:1px solid #f1f1ee;">Start date</td>
                                    <td style="padding:12px 16px;border-bottom:1px solid #f1f1ee;">{{ optional($membership->starts_at)->format('l, M j, Y') ?: '—' }}</td>
                                </tr>
                                <tr>
                                    <td style="padding:12px 16px;color:#6b7280;border-bottom:1px solid #f1f1ee;">Valid until</td>
                            ...
                            <p style="margin:24px 0 0;font-size:15px;line-height:1.6;color:#374151;">
                                Show your Membership ID at the front desk on your first visit. If you have any questions, simply reply to this email.
                            </p>
                            <p style="margin:16px 0 0;font-size:15px;color:#374151;">Stay strong,<br><strong>The {{ config('app.name') }} Team</strong></p>
                        </td>
                    </tr>
                    <tr>
