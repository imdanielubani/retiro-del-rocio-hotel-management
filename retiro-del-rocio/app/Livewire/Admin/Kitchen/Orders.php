...
class Orders extends Component
{
    ...
    /** Advance the order one step forward in the kitchen lifecycle. */
    public function advanceStatus(int $id): void
    {
        $order = DiningOrder::forKitchen()->findOrFail($id);
    ...
    public function render()
    {
        ...
        $stats = [
            ...
            ['label' => 'In the Kitchen', 'value' => $active, 'sub' => 'Confirmed → On the Way', 'accent' => '#2563eb'],
        ...
        return view('admin.kitchen.orders', [
            'orders' => $orders,
            'stats' => $stats,
            ...
            'subtitle' => 'Food orders placed from the guest tablet\'s Place Order screen',
        ]);
    }
}
